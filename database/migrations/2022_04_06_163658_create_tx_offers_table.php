...
class CreateTxOffersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tx_offers', function (Blueprint $table) {
          $table->id();
        ...
        //  $table->foreign('gets_issuer_account_id')->references('id')->on('accounts')->onDelete('restrict');
          $table->index('txhash');
        });
    }
